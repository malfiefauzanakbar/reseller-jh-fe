...
import { resolveModule, defineNuxtModule, isNuxt3, isNuxt2, tryRequireModule, requireModule, extendWebpackConfig, extendViteConfig, createResolver } from '@nuxt/kit';
