        ...
        <div class="lg:flex gap-4 lg:mt-6 mt-3">
            <div class="lg:w-[250px]">
                <div class="flex">
                    <label for="ktp"
                        ...
                        <Field type="file" v-model="ktp" id="ktp" name="ktp" class="hidden"
            ...
            <div class="w-full">
                <div class="lg:grid grid-cols-2 gap-4">
                    <div>
                        <div class="relative lg:mt-0 mt-3">
                            <Field type="text" id="fullname" name="fullname" autocomplete="off"
                    ...
                    <div>
                        <div class="relative lg:mt-0 mt-3">
                            <Field type="text" id="whatsapp_no" name="whatsapp_no" autocomplete="off"
                                class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                :class="{
                    ...
                    <div>
                        <div class="relative lg:mt-0 mt-3">
                            <Field type="text" id="nik" name="nik" autocomplete="off"
                                class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                :class="{
                ...
                <div class="relative lg:mt-4 mt-3">
                    <Field type="text" id="address" name="address" autocomplete="off"
                        class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        :class="{
