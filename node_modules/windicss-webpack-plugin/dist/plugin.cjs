...
const utils = require('./shared/windicss-webpack-plugin.be8c36f4.cjs');
...
const VirtualModulesPlugin__default = /*#__PURE__*/_interopDefaultCompat(VirtualModulesPlugin);
...
function updateCSS(compiler) {
  ...
  compiler.$windi.dirty.add(node_path.resolve(__dirname, "./core/dev-tools-update.js"));
  compiler.$windi.invalidateCssModules(utils.DEVTOOLS_VIRTUAL_MODULE, names);
}
class Server {
  constructor(compiler, options) {
    __publicField$1(this, "server");
    __publicField$1(this, "host");
    __publicField$1(this, "port");
    __publicField$1(this, "_listen");
    var _a, _b;
